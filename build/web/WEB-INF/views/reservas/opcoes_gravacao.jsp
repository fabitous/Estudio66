...
<html>
    ...
    <body>
        <h1 class="text-center">Reserva da sala de gravação</h1>
        <form class="form-group" action="/ProjetoE66/gravacao" method="POST">
          <div class="form-group" id="form_agenda">
            ...
            <div class="form-group">
                ...
                <p>quatidade de pessoas no ensaio (limitado a 10 pessoas no máximo)</p>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Contratar técnico de gravação?*</label>
